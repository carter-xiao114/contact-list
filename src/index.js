...
class ContactsUI extends React.Component {
  render() {
    return (
      <div>
        <div className="header">
          <h1>Contacts</h1>
          <img className="icon_large" src="../add.svg" />
        </div>
        ...
        <Ripple>
          <div className="contact-item">
            <img className="avatar" src="../pic1.png" />
            <div className="info">
              <p className="_20px">John Doe</p>
              <p className="_14px">333 4567111</p>
            </div>
        ...
        <div className="contact-item">
          <img className="avatar" src="../pic4.png" />
          <div className="info">
            <p className="_20px">Alice Smith</p>
            <p className="_14px">333 45667933</p>
          </div>
        </div>
        <div className="contact-item">
          <img className="avatar" src="../pic3.png" />
          <div className="info">
            <p className="_20px">Alice Smith</p>
            <p className="_14px">333 45667933</p>
          </div>
        ...
        <div className="contact-item">
          <img className="avatar" src="../pic7.png" />
          <div className="info">
            <p className="_20px">Alice Smith</p>
            <p className="_14px">333 45667933</p>
          </div>
        ...
        <div className="contact-item">
          <img className="avatar" src="../pic6.png" />
          <div className="info">
            <p className="_20px">Alice Smith</p>
            <p className="_14px">333 45667933</p>
          </div>
